...
Board.prototype.init_canvas = function(canvas_id, scaling_id) {
   ...
   //     <canvas id="' + canvas_id + '" width="' + this.width + '" height="' + this.height + '"><p>Twoja przeglądarka nie obsługuje canvas.</p></canvas>';
    var canvas_init_text = '<canvas id="' + canvas_id + '" width="' + this.width + '" height="' + this.height + '"><p>Twoja przeglądarka nie obsługuje canvas.</p></canvas>';
    ...
    //this.context.arc(10, 10, 5, 0, Math.PI * 2, false);
